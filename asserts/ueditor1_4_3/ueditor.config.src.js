(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl: admin_ueditor_handle

        // 自动抓取远程图片
        ,catchRemoteImageEnable:true
        ,catcherActionUrl: admin_ueditor_handle
        ...
        , toolbars: [[
            ...
            'attachment', 'map', 'insertframe', 'insertcode',   'template', 'background', '|',
            'pagebreak','horizontal', 'date', 'time', 'spechars', 'snapscreen', 'wordimage', '|',
            'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol',
            'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', 'charts', '|',
              'searchreplace', 'drafts'
              /*'gmap', 'help','webapp','preview','print',*/
        ]]
