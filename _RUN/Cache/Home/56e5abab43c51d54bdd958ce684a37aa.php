...
<body>
    ...
    <link rel="stylesheet" href="/asserts/css/baguettebox.min.css">
    <link rel="stylesheet" href="/asserts/css/photo.css">
    <header>
        ...
        <div class="row">
            ...
            <div class="col-md-2 about-left" style="padding:0px;">
                <div class="about-title">
                    ...
                    <h4><a href="<?php echo U('/Articles');?>">我们在行动</a></h4>
                    <h4><a href="<?php echo U('/Album');?>" class="active2">相册</a></h4>
                </div>
    ...
    <a href="#" class="org-btn">我要报名</a>
            ...
            <div class="col-md-10 about-desc">
                ...
                <hr>
                <p><?php echo ($album["description"]); ?></p><br><br>
                <iframe frameborder="0" style="display: none;"></iframe>
                <!-- 代码 开始 -->
                <div class="baguetteBoxOne gallery ">
                    <?php if(is_array($list)): foreach($list as $key=>$v): ?><a href="<?php echo ($v["path"]); ?>" class="thumbnail"><img src="<?php echo ($v["path"]); ?>"></a><?php endforeach; endif; ?>
                </div>
                <div id="bdshare_s" style="display: block;">
                    <iframe id="bdsIfr"
                            style="position: absolute; display: none; z-index: 9999; top: 44px; left: 1380px; height: 314px; width: 212px;"
    ...
    <script src="/asserts/js/baguettebox.min.js"></script>
    <script>
