            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="menu-main">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="<?php echo U('/News');?>" <?php if(CONTROLLER_NAME == 'News'): ?>class="active"<?php endif; ?> >最新资讯</a></li>
                        <li><a href="#">公益伙伴</a></li>
                        <li><a href="#">关于捐赠</a></li>
                    </ul>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-2 about-left" style="padding:0px;">
                <div class="about-title">
                    ...
                    <h4><a href="<?php echo U('/News/articlelist');?>" class="active2">我们在行动</a></h4>
                    <h4><a href="<?php echo U('/Article/contact');?>">相册</a></h4>
                </div>
                <div class="left-donate">
                    <a href="#" class="org-btn">我要捐款</a>
