...
<body>
    ...
    <a href="#" class="org-btn">我要报名</a>
            ...
            <div class="col-md-10 about-desc">
                ...
                <?php if(is_array($data_news)): foreach($data_news as $key=>$v): ?><div class="col-md-4">
                        <a href="<?php echo U('photo',array('aid'=>$v['id']));?>" class="thumbnail">
                            <img src="<?php echo ($v["cover"]); ?>" style="height: 150px;">
                            <div class="caption">
