        ...
        <div class="row">
            <div class="col-md-2 about-left" style="padding:0px;">
                <div class="about-title">
                    <h3>公益伙伴</h3>
                    <em></em>
                    <h4><a href="" class="active2">公益伙伴</a></h4>
                </div>
            ...
            <div class="col-md-10 about-desc">
                ...
                <div class="partnerBg">
                    <ul class="c">
                        ...
                        <?php foreach(D('Partner','Service')->getlist(1) as $v){ ?>

                        <li><a href=""><img src="/<?php echo ($v["logo"]); ?>" alt="<?php echo (htmlspecialchars($v["name"])); ?>"
                                            title="<?php echo (htmlspecialchars($v["name"])); ?>" width="95"
                                            height="66"></a></li>
                        <?php } ?>
