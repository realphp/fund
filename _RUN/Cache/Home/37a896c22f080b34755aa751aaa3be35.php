...
<body>
        ...
        <div class="row">
            <div class="col-md-2 about-left" style="padding:0px;">
                <div class="about-title">
                    <h3>关于我们</h3>
                    <em></em>
                    <h4 class="h4-one"><a href="<?php echo U('/About');?>">永翔基金会介绍</a></h4>
                    <h4 class="h4-two"><a href="<?php echo U('/About/contact');?>" class="active2">联系我们</a></h4>
                </div>
    ...
    <a href="#" class="org-btn">我要报名</a>
            ...
            <div class="col-md-10 about-desc">
                ...
                <h5 style="color:#F39700; ">爱心热线：400-000-8884</h5>
                </p>
            </div>
        </div>
    </div>
