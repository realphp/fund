...
<div id="frame-content">
    ...
    <link rel="stylesheet" href="/asserts/zyupload/control/css/zyUpload.css" type="text/css">
    <script type="text/javascript" src="/asserts/zyupload/core/zyFile.js"></script>
    <script type="text/javascript" src="/asserts/zyupload/control/js/zyUpload.js"></script>
    ...
    <div class="container-fluid photo-box">
        <div class="row">
            <?php if(is_array($list)): foreach($list as $key=>$v): ?><div class="col-md-2" id="photo_<?php echo ($v["id"]); ?>">
                    <a href="#" class="thumbnail" style="position: relative">
                        <span class="glyphicon glyphicon-remove" style="position: absolute;top:2px;right: 2px;font-size: 15px;display: none;" onclick="del('<?php echo ($v["id"]); ?>')"  ></span>
                        <img src="<?php echo ($v["path"]); ?>" style="height: 200px;">
                    </a>
    ...
    <script type="text/javascript">
        var url = "<?php echo U('upload',array('id'=>$_GET['id']));?>";
    ...
    <script type="text/javascript" src="/asserts/zyupload/core/jq22.js"></script>
