...
<div id="frame-content">
    ...
    <table id="table-grid" class="table table-hover">
        <thead>
            <tr>
                ...
                <th data-column-id="uptime" data-sortable="false"><?php echo (L("file_uptime")); ?></th>
                <th data-column-id="fullpath" data-formatter="fullpath" data-sortable="false"><?php echo (L("file_path")); ?></th>
                <th data-column-id="filesize" data-sortable="false">文件大小</th>
                <th data-column-id="commands" data-formatter="commands" data-sortable="false"><?php echo (L("operation")); ?></th>
            </tr>
        </thead>
    </table>
    ...
    <script type="text/javascript">
    var grid;
    /*<?php if(access_permit('filehandle')): ?>*/
    var grid_buttons = ['<div class="btn-group">',
        '<a href="javascript:void(0);" onclick="admin_grid_delete(\'<?php echo U(CONTROLLER_NAME.'/filehandle?action=delete');?>\');" class="btn btn-default"><span class="glyphicon glyphicon-trash"></span></a>',
        '</div>'].join('');
    /*<?php else: ?>*/
    var grid_buttons = '';
    /*<?php endif; ?>*/
...
search: "<?php echo (L("search")); ?>"
            ...
            url: "<?php echo U(CONTROLLER_NAME.'/filelist');?>",
            formatters: {
                ...
                fullpath: function(col, row){
                    return "<a href='/data/" + row.fullpath + "' target='_blank'>" + row.fullpath + "</a>";
                }
            }
            ...
            grid.find(".command-delete").on("click", function(e){
                ...
                admin_grid_delete_one( "<?php echo U(CONTROLLER_NAME.'/filehandle?action=delete');?>", $(this).data("row-id"));
