...
<div id="frame-content">
    ...
    <form class="form-horizontal tpx-ajaxsubmit" role="form" action="<?php echo U(CONTROLLER_NAME.'/'.ACTION_NAME);?>" method="post">
        ...
        <?php if(is_array($data_domains)): foreach($data_domains as $domain=>$category): ?><div class="form-group">
                <div class="col-sm-2">
                    <select class="form-control" name="app[]">
                        <?php if(is_array($data_apps)): foreach($data_apps as $app=>$label): ?><option value="<?php echo (t_html($app)); ?>" <?php if($category==$app): ?>selected<?php endif; ?>><?php echo (t_html($label)); ?></option><?php endforeach; endif; ?>
                    </select>
                </div>
                <div class="col-sm-8">
                    <input name="domain[]"
        ...
        <script type="text/html" id="domain_add_html">
            <div class="form-group">
                <div class="col-sm-2">
                    <select class="form-control" name="app[]">
                        <?php if(is_array($data_apps)): foreach($data_apps as $app=>$label): ?><option value="<?php echo (t_html($app)); ?>"><?php echo (t_html($label)); ?></option><?php endforeach; endif; ?>
                    </select>
                </div>
                <div class="col-sm-8">
                    <input name="domain[]"
