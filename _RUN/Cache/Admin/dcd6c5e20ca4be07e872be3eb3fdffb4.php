        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input name="contact_address"
                       ...
                       class="form-control"
                       placeholder=""
                       value="<?php echo (t_html($contact_address)); ?>"
                        />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input name="contact_email"
                       ...
                       class="form-control"
                       placeholder=""
                       value="<?php echo (t_html($contact_email)); ?>"
                        />
                <div class="help-block"></div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input name="contact_website"
                       ...
                       class="form-control"
                       placeholder=""
                       value="<?php echo (t_html($contact_website)); ?>"
                        />
                <div class="help-block"></div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input name="contact_tel"
                       ...
                       class="form-control"
                       placeholder=""
                       value="<?php echo (t_html($contact_tel)); ?>"
                        />
                <div class="help-block"></div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input name="contact_qq"
                       ...
                       class="form-control"
                       placeholder=""
                       value="<?php echo (t_html($contact_qq)); ?>"
                        />
                <div class="help-block"></div>
            </div>
        </div>
