...
<div id="frame-content">
    ...
    <table id="table-grid" class="table table-hover">
        <thead>
            <tr>
                ...
                <th data-column-id="username" data-sortable="false"><?php echo (L("username")); ?></th>
                <th data-column-id="last_login_time" data-sortable="false"><?php echo (L("last_login_time")); ?></th>
                <th data-column-id="last_login_ip" data-sortable="false"><?php echo (L("last_login_ip")); ?></th>
                <th data-column-id="roles" data-sortable="false"><?php echo (L("role")); ?></th>
                <th data-column-id="status" data-formatter="status" data-sortable="false"><?php echo (L("status")); ?></th>
                <?php if(access_permit('userhandle')): ?><th data-column-id="commands" data-formatter="commands" data-sortable="false"><?php echo (L("operation")); ?></th><?php endif; ?>
            </tr>
        </thead>
    </table>
    ...
    <script type="text/javascript">
    var grid;
    /*<?php if(access_permit('userhandle')): ?>*/
    var grid_buttons = ['<div class="btn-group">',
        '<a href="<?php echo U(CONTROLLER_NAME.'/userhandle?action=add');?>" class="btn btn-default"><span class="glyphicon glyphicon-plus"></span></a>',
        '<a href="javascript:void(0);" onclick="admin_grid_delete(\'<?php echo U(CONTROLLER_NAME.'/userhandle?action=delete');?>\');" class="btn btn-default"><span class="glyphicon glyphicon-trash"></span></a>',
        '</div>'].join('');
    /*<?php else: ?>*/
    var grid_buttons = '';
    /*<?php endif; ?>*/
...
search: "<?php echo (L("search")); ?>"
            ...
            url: "<?php echo U(CONTROLLER_NAME.'/userlist');?>",
            ...
            grid.find(".command-edit").on("click", function(e){
                ...
                $.redirect( "<?php echo U('Administrator/userhandle?action=edit&id=-id-');?>".replace('-id-', $(this).data("row-id") ));
                return false;

            }).end().find(".command-delete").on("click", function(e){

                if(confirm('<?php echo (L("delete")); ?>?')){
                    admin_grid_delete_one( "<?php echo U('Administrator/userhandle?action=delete');?>", $(this).data("row-id"));
                }
                return false;
