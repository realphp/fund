...
<form class="form-horizontal tpx-ajaxsubmit" role="form" action="<?php echo U('Administrator/nodehandle?action=add');?>" method="post">

    <div class="form-group">
        <label class="col-sm-2 control-label"><?php echo (L("node_name")); ?></label>
        <div class="col-sm-10">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label"><?php echo (L("node_title")); ?></label>
        <div class="col-sm-10">
            <input name="title" type="text" class="form-control" placeholder="" required="required" value="<?php echo (htmlspecialchars($data_title)); ?>" style="width:auto;" />
            <div class="help-block"></div>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label"><?php echo (L("node_sort")); ?></label>
        <div class="col-sm-10">
            <input name="sort" type="text" class="form-control" placeholder="" required="required" value="<?php echo (htmlspecialchars($data_sort)); ?>" style="width:auto;" />
            <div class="help-block"></div>
        </div>
    </div>

    <div class="form-group">
        <label class="col-sm-2 control-label"><?php echo (L("node_status")); ?></label>
        <div class="col-sm-10">
    ...
    <input type="hidden" name="pid" value="<?php echo ($data_pid); ?>" />
