...
<form class="form-horizontal tpx-ajaxsubmit" role="form" action="<?php echo U('Administrator/userhandle?action=add');?>" method="post">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input name="password" type="text" class="form-control" placeholder="" required="required" value="<?php echo (htmlspecialchars($data_password)); ?>" style="width:auto;" />
            <div class="help-block"></div>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <?php if(is_array($data_rolelist)): foreach($data_rolelist as $k=>$r): ?><div>
                    <label class="checkbox-inline">
                        <input type="checkbox" class="checkbox-parent" name="roleids[]" id="roleids-<?php echo ($r["id"]); ?>" value="<?php echo ($r["id"]); ?>" />
                        <?php echo ($r["name"]); ?>
                    </label>
