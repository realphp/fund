...
<div id="frame-content">
    ...
    <table class="table table-striped">
        <thead>
            <tr>
                ...
                <th><?php echo (L("db_engine")); ?></th>
                <th><?php echo (L("fields_cnt")); ?></th>
                <th><?php echo (L("record_cnt")); ?></th>
                <th><?php echo (L("operation")); ?></th>
            </tr>
        </thead>
        <tbody>
            <?php if(is_array($mods)): foreach($mods as $key=>$v): ?><tr>
                    <td><?php echo ($v["name"]); ?></td>
                    <td><?php echo ($v["table"]); ?></td>
                    <td><?php echo ($v["db_engine"]); ?></td>
                    <td><?php echo ($v["fields_cnt"]); ?></td>
                    <td><?php echo ($v["record_cnt"]); ?></td>
                    <td>
                        <?php if(is_founder()): ?><a href="#" title="<?php echo (L("build")); ?>" onclick="admin_mod_build('<?php echo ($v["name"]); ?>');"><span class="glyphicon glyphicon-refresh"></span></a>
                            &nbsp;&nbsp;&nbsp;&nbsp;<?php endif; ?>
                        <a href="<?php echo U('Cms'.$v['name'].'/cmslist');?>" title="<?php echo (L("jump")); ?>"><span class="glyphicon glyphicon-share-alt"></span></a>
                    </td>
    ...
    function admin_mod_build(mod){
        var url = "<?php echo U('Cms-controller-/build');?>";
