...
<form class="form-horizontal tpx-ajaxsubmit" role="form" action="<?php echo U('Administrator/userhandle?action=edit&id='.$data_id);?>" method="post">

    <div class="form-group">
        <label class="col-sm-2 control-label"><?php echo (L("username")); ?></label>
        <div class="col-sm-10">
            <input name="username" type="text" class="form-control" placeholder="" required="required" value="<?php echo (htmlspecialchars($data_username)); ?>" style="width:auto;" />
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input name="password" type="text" class="form-control" placeholder="<?php echo (L("empty_means_no_change")); ?>" value="<?php echo (htmlspecialchars($data_password)); ?>" style="width:auto;" />
            <div class="help-block"></div>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label"><?php echo (L("role")); ?></label>
        <div class="col-sm-10">

            <?php if(is_array($data_rolelist)): foreach($data_rolelist as $k=>$r): ?><div>
                    <label class="checkbox-inline">
                        <?php if(in_array($r['id'],$data_roleids)): ?><input type="checkbox" class="checkbox-parent" checked="checked" name="roleids[]" id="roleids-<?php echo ($r["id"]); ?>" value="<?php echo ($r["id"]); ?>" />
                        <?php else: ?>
                            <input type="checkbox" class="checkbox-parent" name="roleids[]" id="roleids-<?php echo ($r["id"]); ?>" value="<?php echo ($r["id"]); ?>" /><?php endif; ?>
                        <?php echo ($r["name"]); ?>
                    </label>
