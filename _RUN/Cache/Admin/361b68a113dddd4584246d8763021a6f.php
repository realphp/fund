    ...
    <form class="form-horizontal tpx-ajaxsubmit" role="form" action="<?php echo U(CONTROLLER_NAME.'/'.ACTION_NAME);?>" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <div class="radio">
                    <label>
                        <input type="radio" name="system_rewrite_enable" value="1" <?php if($system_rewrite_enable): ?>checked<?php endif; ?> /> 开启
                    </label>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <label>
                        <input type="radio" name="system_rewrite_enable" value="0" <?php if(!$system_rewrite_enable): ?>checked<?php endif; ?> /> 关闭
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input name="home_title"
                       type="text"
                       class="form-control"
                       placeholder=""
                       value="<?php echo (t_html($home_title)); ?>"
                        />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input name="home_keywords"
                       type="text"
                       class="form-control"
                       placeholder=""
                       value="<?php echo (t_html($home_keywords)); ?>"
                        />
                <div class="help-block"></div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input name="home_description"
                       type="text"
                       class="form-control"
                       placeholder=""
                       value="<?php echo (t_html($home_description)); ?>"
                        />
                <div class="help-block"></div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input name="basic_copyright"
                       type="text"
                       class="form-control"
                       placeholder=""
                       value="<?php echo (t_html($basic_copyright)); ?>"
                        />
                <div class="help-block"></div>
            </div>
        </div>
